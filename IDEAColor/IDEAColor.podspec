Pod::Spec.new do |spec|
  spec.name                 = "IDEAColor"
  spec.version              = "1.0.0"
  spec.summary              = "IDEAColor"
  spec.description          = "IDEAColor"
...
#  spec.platform             = :ios, ENV['ios.deployment_target']
  ...
  spec.ios.pod_target_xcconfig      = {
                                        'PRODUCT_BUNDLE_IDENTIFIER' => 'com.idea.IDEAColor',
  ...
  spec.osx.pod_target_xcconfig      = { 'PRODUCT_BUNDLE_IDENTIFIER' => 'com.idea.IDEAColor' }
