Pod::Spec.new do |spec|
  spec.name                 = "UICycleScrollView"
  spec.version              = "1.0.0"
  spec.summary              = "UICycleScrollView"
  spec.description          = "UICycleScrollView"
...
#  spec.tvos.deployment_target     = '10.0'
  ...
  spec.ios.pod_target_xcconfig     = {
                                        'PRODUCT_BUNDLE_IDENTIFIER' => 'com.idea.UICycleScrollView',
                                        'ENABLE_BITCODE'            => 'NO',
                                        'SWIFT_VERSION'             => '5.0',
  ...
  spec.osx.pod_target_xcconfig      = { 'PRODUCT_BUNDLE_IDENTIFIER' => 'com.idea.UICycleScrollView' }
  spec.watchos.pod_target_xcconfig  = { 'PRODUCT_BUNDLE_IDENTIFIER' => 'com.idea.UICycleScrollView-watchOS' }
  spec.tvos.pod_target_xcconfig     = { 'PRODUCT_BUNDLE_IDENTIFIER' => 'com.idea.UICycleScrollView' }
...
#                                              "${PODS_CONFIGURATION_BUILD_DIR}/YYKit",
  ...
  spec.pod_target_xcconfig          = {
    'GCC_PREPROCESSOR_DEFINITIONS'      => [ ' MODULE=\"UICycleScrollView\" ' ]
                                      }
  ...
  spec.public_header_files        = 'UICycleScrollView/**/*.h'

  spec.source_files               = 'UICycleScrollView/**/*.{h,m,mm,c,cpp}'
