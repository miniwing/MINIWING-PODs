...
- (void)netStartTraceroute:(NSString *_Nonnull)host tracerouteResultHandler:(NetTracerouteResultHandler _Nonnull)handler completionHandler:(CompletionHandler)aCompletionHandler;
