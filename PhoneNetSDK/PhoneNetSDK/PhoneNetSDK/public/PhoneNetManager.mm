...
- (void)netStartTraceroute:(NSString *_Nonnull)host
   tracerouteResultHandler:(NetTracerouteResultHandler _Nonnull)handler
         completionHandler:(CompletionHandler)aCompletionHandler {
   ...
   [[PhoneTraceRouteService shareInstance] startTracerouteHost:host resultHandler:handler completionHandler:aCompletionHandler];
