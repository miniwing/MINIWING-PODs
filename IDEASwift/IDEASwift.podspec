Pod::Spec.new do |spec|
  spec.name                 = "IDEASwift"
  spec.version              = "1.0.0"
  spec.summary              = "IDEASwift"
  spec.description          = "IDEASwift"
...
#  spec.tvos.deployment_target     = '10.0'
  ...
  spec.ios.pod_target_xcconfig     = {
                                        'PRODUCT_BUNDLE_IDENTIFIER' => 'com.idea.IDEASwift',
                                        'ENABLE_BITCODE'            => 'NO',
                                        'SWIFT_VERSION'             => '5.0',
  ...
  spec.osx.pod_target_xcconfig      = { 'PRODUCT_BUNDLE_IDENTIFIER' => 'com.idea.IDEASwift' }
  spec.watchos.pod_target_xcconfig  = { 'PRODUCT_BUNDLE_IDENTIFIER' => 'com.idea.IDEASwift-watchOS' }
  spec.tvos.pod_target_xcconfig     = { 'PRODUCT_BUNDLE_IDENTIFIER' => 'com.idea.IDEASwift' }
...
#                                              "${PODS_CONFIGURATION_BUILD_DIR}/YYKit",
  ...
  spec.pod_target_xcconfig          = {
    'GCC_PREPROCESSOR_DEFINITIONS'      => [ ' MODULE=\"IDEASwift\" ' ]
                                      }
...
#    sub.ios.source_files        = 'IDEASwift/IDEASwift/**/*.{h,m,mm}'
#    sub.ios.public_header_files = 'IDEASwift/IDEASwift/**/*.{h}'
#    sub.ios.header_dir          = 'IDEASwift'
