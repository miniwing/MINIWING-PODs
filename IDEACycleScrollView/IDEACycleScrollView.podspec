Pod::Spec.new do |spec|
  spec.name         = "IDEACycleScrollView"
  spec.version      = "1.0.0"
  spec.summary      = "IDEACycleScrollView"
  spec.description  = "IDEACycleScrollView"
  # https://github.com/QuintGao/GKIDEACycleScrollView.git
  ...
  spec.ios.pod_target_xcconfig      = {
                                        'PRODUCT_BUNDLE_IDENTIFIER' => 'com.idea.IDEACycleScrollView',
                                        'ENABLE_BITCODE'            => 'NO',
                                        'SWIFT_VERSION'             => '5.0',
  ...
  spec.osx.pod_target_xcconfig      = { 'PRODUCT_BUNDLE_IDENTIFIER' => 'com.idea.IDEACycleScrollView' }
  spec.watchos.pod_target_xcconfig  = { 'PRODUCT_BUNDLE_IDENTIFIER' => 'com.idea.IDEACycleScrollView-watchOS' }
  spec.tvos.pod_target_xcconfig     = { 'PRODUCT_BUNDLE_IDENTIFIER' => 'com.idea.IDEACycleScrollView' }
...
#                                            "${PODS_ROOT}/Headers/Public/YYKit/"
  ...
  spec.pod_target_xcconfig          = {
    'GCC_PREPROCESSOR_DEFINITIONS'      => [
                                              ' MODULE=\"IDEACycleScrollView\" ',
                                              ' BUNDLE=\"IDEACycleScrollView\" '
                                            ]
                                      }
...
#  spec.dependency 'UserManager'

  spec.public_header_files  = 'IDEACycleScrollView/**/*.h'
  spec.source_files         = 'IDEACycleScrollView/**/*.{h,hpp,hxx,m,c,cpp,cxx}'
  
  spec.requires_arc         = true
  
  spec.resources            = 'IDEACycleScrollView/**/*.{xib,storyboard}'

  spec.resource_bundles     = {
                                'IDEACycleScrollView' => [
                                                        'IDEACycleScrollView/*.lproj/*.strings',
                                                        'IDEACycleScrollView/*.xcassets'
                                                     ]
                              }
