...
Pod::Spec.new do |spec|
  spec.name                 = 'IDEATiercel'
  spec.version              = '3.2.5'
  spec.summary              = 'IDEATiercel is a lightweight, pure-Swift download framework.'
  spec.description          = "IDEATiercel"
  spec.homepage             = "https://github.com/miniwing"
  spec.license              = "MIT"
  spec.author               = { "Harry" => "miniwing.hz@gmail.com" }


  spec.homepage             = 'https://github.com/Danie1s/Tiercel'
#  spec.license              = { :type => 'MIT', :file => 'LICENSE' }
#  spec.author               = { 'Daniels' => '176516837@qq.com' }
#  spec.source               = { :git => 'https://github.com/Danie1s/Tiercel.git', :tag => s.version.to_s }
  spec.source                     = { :path => "." }
  ...
  spec.ios.pod_target_xcconfig     = {
                                        'PRODUCT_BUNDLE_IDENTIFIER' => 'com.idea.IDEATiercel',
                                        'ENABLE_BITCODE'            => 'NO',
                                        'SWIFT_VERSION'             => '5.0',
  ...
  spec.osx.pod_target_xcconfig      = { 'PRODUCT_BUNDLE_IDENTIFIER' => 'com.idea.IDEATiercel' }
  spec.watchos.pod_target_xcconfig  = { 'PRODUCT_BUNDLE_IDENTIFIER' => 'com.idea.IDEATiercel-watchOS' }
  spec.tvos.pod_target_xcconfig     = { 'PRODUCT_BUNDLE_IDENTIFIER' => 'com.idea.IDEATiercel' }
...
#                                            "${PODS_ROOT}/Headers/Public/IDEATiercel/",
...
#                                              "${PODS_CONFIGURATION_BUILD_DIR}/YYKit",
  ...
  spec.pod_target_xcconfig          = {
    'GCC_PREPROCESSOR_DEFINITIONS'  => [ ' MODULE=\"IDEATiercel\" ' ]
  }

  spec.source_files = 'IDEATiercel/**/*.swift'
