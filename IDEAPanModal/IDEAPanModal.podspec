...
Pod::Spec.new do |spec|
  spec.name             = 'IDEAPanModal'
  spec.version          = '0.9.5-IDEA'
  spec.summary          = 'IDEAPanModal is used to present controller and drag to dismiss.'
...
#   * Finally, don't worry about the indent, CocoaPods strips it!
  ...
  spec.description      = <<-DESC
                       IDEAPanModal presents controller from bottom and drag to dismiss, high customize.
                       DESC

  spec.homepage         = 'https://github.com/HeathWang/HWPanModal'
  ...
  spec.osx.pod_target_xcconfig      = { 'PRODUCT_BUNDLE_IDENTIFIER' => 'com.idea.IDEAPanModal' }
  spec.watchos.pod_target_xcconfig  = { 'PRODUCT_BUNDLE_IDENTIFIER' => 'com.idea.IDEAPanModal-watchOS' }
