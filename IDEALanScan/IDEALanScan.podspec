Pod::Spec.new do |spec|
  spec.name                 = 'IDEALanScan'
  spec.version              = '3.0.0-IDEA'
  spec.summary              = 'IDEALanScan is an open source project for iOS that helps you scan your network and shows the available devices.'
  ...
  spec.homepage             = 'https://github.com/mavris/MMLanScan'
  spec.license              = { :type => 'MIT', :file => 'LICENSE.txt' }
  spec.author               = { 'Michael Mavris' => 'info@miksoft.net' }
  spec.author               = { 'Harry' => 'miniwing.hz@gmail.com' }
  spec.source               = { :git => 'https://github.com/mavris/MMLanScan.git', :tag => spec.version.to_s }
...
#  spec.tvos.deployment_target     = '10.0'
  ...
  spec.ios.pod_target_xcconfig      = {
                                         'PRODUCT_BUNDLE_IDENTIFIER' => 'com.idea.IDEALanScan',
                                         'ENABLE_BITCODE'            => 'NO',
                                         'SWIFT_VERSION'             => '5.0',
  ...
  spec.osx.pod_target_xcconfig      = { 'PRODUCT_BUNDLE_IDENTIFIER' => 'com.idea.IDEALanScan' }
  spec.watchos.pod_target_xcconfig  = { 'PRODUCT_BUNDLE_IDENTIFIER' => 'com.idea.IDEALanScan-watchOS' }
  spec.tvos.pod_target_xcconfig     = { 'PRODUCT_BUNDLE_IDENTIFIER' => 'com.idea.IDEALanScan' }
...
#  spec.dependency 'SimplePing'
  ...
  spec.source_files                 = 'IDEALanScan/*.{h,m}'

  spec.subspec 'libs' do |libs|
    libs.ios.public_header_files    = 'IDEALanScan/Libs/**/*.{h,hpp}'
    libs.ios.source_files           = 'IDEALanScan/Libs/**/*.{h,m,mm}'
  end

  spec.subspec 'misc' do |misc|
    misc.ios.public_header_files    = 'IDEALanScan/Misc/**/*.{h,hpp}'
    misc.ios.source_files           = 'IDEALanScan/Misc/**/*.{h,m,mm}'
  end

  spec.subspec 'objects' do |objects|
    objects.ios.public_header_files = 'IDEALanScan/Objects/**/*.{h,hpp}'
    objects.ios.source_files        = 'IDEALanScan/Objects/**/*.{h,m,mm}'
  end
