Pod::Spec.new do |spec|
  spec.name                 = "IDEACycleView"
  spec.version              = "1.0.0"
  spec.summary              = "IDEACycleView"
  spec.description          = "IDEACycleView"
...
#  spec.tvos.deployment_target     = '10.0'
  ...
  spec.ios.pod_target_xcconfig     = {
                                        'PRODUCT_BUNDLE_IDENTIFIER' => 'com.idea.IDEACycleView',
                                        'ENABLE_BITCODE'            => 'NO',
                                        'SWIFT_VERSION'             => '5.0',
  ...
  spec.osx.pod_target_xcconfig      = { 'PRODUCT_BUNDLE_IDENTIFIER' => 'com.idea.IDEACycleView' }
  spec.watchos.pod_target_xcconfig  = { 'PRODUCT_BUNDLE_IDENTIFIER' => 'com.idea.IDEACycleView-watchOS' }
  spec.tvos.pod_target_xcconfig     = { 'PRODUCT_BUNDLE_IDENTIFIER' => 'com.idea.IDEACycleView' }
...
#                                              "${PODS_CONFIGURATION_BUILD_DIR}/YYKit",
  ...
  spec.pod_target_xcconfig          = {
    'GCC_PREPROCESSOR_DEFINITIONS'      => [ ' MODULE=\"IDEACycleView\" ' ]
                                      }

#  spec.dependency 'FoundationExtension'
#  spec.dependency 'UIKitExtension'
  
  spec.public_header_files        = 'IDEACycleView/**/*.h'

  spec.source_files               = 'IDEACycleView/**/*.{h,m,mm,c,cpp}'
