Pod::Spec.new do |spec|
  spec.name                         = "IDEAUIRouter"
  spec.version                      = "0.4.1-IDEA"
  spec.summary                      = "IDEAUIRouter"
  spec.description                  = "IDEAUIRouter"
...
#  spec.source                       = { :path => "." }
  ...
  spec.ios.pod_target_xcconfig      = {
                                      'PRODUCT_BUNDLE_IDENTIFIER' => 'com.idea.IDEAUIRouter',
                                      'ENABLE_BITCODE'            => 'NO',
                                      'SWIFT_VERSION'             => '5.0',
  ...
  spec.osx.pod_target_xcconfig      = { 'PRODUCT_BUNDLE_IDENTIFIER' => 'com.idea.IDEAUIRouter' }
