...
#                               ]
  ...
  spec.pod_target_xcconfig  = {
    'GCC_PREPROCESSOR_DEFINITIONS'  => ' MODULE=\"IDEANavigationBar\" '
  }
...
#  spec.dependency 'MBProgressHUD',              '~> 0.9.2'
  ...
  spec.public_header_files    = 'IDEANavigationBar.h',
                                'IDEANavigationBar/**/*.{h}',
                                'IDEANavigationBarExtension/**/*.{h}'

  spec.source_files           = 'IDEANavigationBar.h',
                                'IDEANavigationBar/**/*.{h,m,mm,c,cpp}'

  spec.requires_arc           = true

#  spec.subspec 'IDEAVendor' do |sub|
#    sub.dependency 'UIKitExtension'
#    sub.public_header_files   = 'IDEANavigationBar/IDEAVendor/*.h'
#    sub.source_files          = 'IDEANavigationBar/IDEAVendor/*.{h,m}'
