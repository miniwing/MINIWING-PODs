...
@property (copy, nonatomic) void (^albumTitleView)(HXAlbumTitleView *aAlbumTitleView);
@property (copy, nonatomic) void (^sectionFooterView)(HXPhotoViewSectionFooterView *aSectionFooterView);
@property (copy, nonatomic) void (^photoLimitView)(HXPhotoLimitView *aPhotoLimitView);
