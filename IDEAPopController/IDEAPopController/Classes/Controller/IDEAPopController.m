...
@property (nonatomic, weak) IDEAPopController *popController;

@end

@interface IDEAPopContainerViewController : UIViewController

@end

@implementation IDEAPopContainerViewController

@end

@interface IDEAPopController ()

@property (nonatomic, strong) IDEAPopContainerViewController *containerViewController;
...
@property (nonatomic, strong) IDEAPopTransitioningDelegate *transitioningDelegate;

@end

@implementation IDEAPopController
...
- (void)adjustContainerViewOrigin {
   ...
   CGFloat offsetY = 0;
   if (self.popPosition == IDEAPopPositionBottom) {
...
- (void)setup {
   ...
   self.popType = IDEAPopTypeGrowIn;
   self.dismissType = IDEADismissTypeFadeOut;
...
- (IDEAPopContainerViewController *)containerViewController {
   if (!_containerViewController) {
      _containerViewController = [IDEAPopContainerViewController new];
      _containerViewController.modalPresentationStyle = UIModalPresentationCustom;
      self.transitioningDelegate = [[IDEAPopTransitioningDelegate alloc] initWithPopController:self];
