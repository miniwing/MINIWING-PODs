...
typedef UIImage *(^DKImagePicker)(DKThemeVersion *aThemeVersion);

/**
 *  A C function takes an array of images return a image picker, the
 *  order of the images is just like the themes order in ColorTable.txt
 *  file.
 *
...
+ (DKImagePicker)pickerWithNormalImageName:(NSString *)normalImage nightImageName:(NSString *)nightImage;
