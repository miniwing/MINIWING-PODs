Pod::Spec.new do |spec|
  spec.name                         = "IDEANightVersion"
  spec.version                      = "3.0.0"
  spec.summary                      = "IDEANightVersion"
  spec.description                  = "IDEANightVersion"
  spec.homepage                     = "https://github.com/draveness/DKNightVersion.git"
  spec.license                      = "MIT"
...
#  spec.source                       = { :path => "." }
  ...
  spec.osx.pod_target_xcconfig      = { 'PRODUCT_BUNDLE_IDENTIFIER' => 'com.idea.IDEANightVersion' }
...
#  elif __has_include("IDEAApplet/IDEAAppletDebug.h")
#     import "IDEAApplet/IDEAAppletDebug.h"
