...
#ifndef IDEA_WKAVAILABILITY_h
#define IDEA_WKAVAILABILITY_h
...
/*
 ...
 IDEA_AVAILABLE_SDK_IOS(_ios) evaluates to true when the maximum target SDK is
  ...
  #if IDEA_AVAILABLE_SDK_IOS(13_0)
    // iOS 13 specific code.
  #endif
 */

#define IDEA_AVAILABLE_SDK_IOS(_ios)      \
                                          ((__IPHONE_##_ios != 0) &&                           \
                                           (__IPHONE_OS_VERSION_MAX_ALLOWED >= __IPHONE_##_ios))

#endif // IDEA_WKAVAILABILITY_h
