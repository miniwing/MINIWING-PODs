Pod::Spec.new do |spec|
  spec.name             = "IDEAGeigerCounter"
  spec.version          = "0.3.0-IDEA"
  spec.summary          = "A framerate meter that clicks when animation drops frames"
  spec.homepage         = "https://github.com/kconner/IDEAGeigerCounter"
  spec.license          = { :type => 'MIT', :file => 'LICENSE' }
  spec.author           = { "Kevin Conner" => "connerk@gmail.com" }
  spec.social_media_url = "http://twitter.com/connerk"
  spec.source           = { :git => "https://github.com/kconner/IDEAGeigerCounter.git", :tag => spec.version.to_s }
  ...
  spec.ios.pod_target_xcconfig      = {
                                        'PRODUCT_BUNDLE_IDENTIFIER' => 'com.idea.IDEAGeigerCounter',
                                        'ENABLE_BITCODE'            => 'NO',
                                        'SWIFT_VERSION'             => '5.0',
  ...
  spec.osx.pod_target_xcconfig      = { 'PRODUCT_BUNDLE_IDENTIFIER' => 'com.idea.IDEAGeigerCounter' }
  spec.watchos.pod_target_xcconfig  = { 'PRODUCT_BUNDLE_IDENTIFIER' => 'com.idea.IDEAGeigerCounter-watchOS' }
  spec.tvos.pod_target_xcconfig     = { 'PRODUCT_BUNDLE_IDENTIFIER' => 'com.idea.IDEAGeigerCounter' }

  spec.pod_target_xcconfig          = {
    'GCC_PREPROCESSOR_DEFINITIONS'      => [ ' MODULE=\"IDEAGeigerCounter\" ', ' BUNDLE=\"IDEAGeigerCounter\" ' ]
  }

  spec.requires_arc     = true
  spec.source_files     = "IDEAGeigerCounter/*.{h,m}"
  spec.resources        = "IDEAGeigerCounter/*.aiff"
