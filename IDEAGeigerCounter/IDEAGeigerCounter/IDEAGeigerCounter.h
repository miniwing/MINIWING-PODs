...
typedef NS_ENUM(NSUInteger, IDEAGeigerCounterPosition) {
    IDEAGeigerCounterPositionLeft,
    IDEAGeigerCounterPositionMiddle,
    IDEAGeigerCounterPositionRight
};

@interface IDEAGeigerCounter : NSObject

// Set [IDEAGeigerCounter sharedGeigerCounter].enabled = YES from -application:didFinishLaunchingWithOptions:.
...
@property (nonatomic, assign) IDEAGeigerCounterPosition position;
