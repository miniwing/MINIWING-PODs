Pod::Spec.new do |spec|
  spec.name                 = "IDEAFONT"
  spec.version              = "1.0.0"
  spec.summary              = "IDEAFONT"
  spec.description          = "IDEAFONT"
...
#  spec.platform             = :ios, "10.0"
  ...
  spec.ios.pod_target_xcconfig      = {
                                        'PRODUCT_BUNDLE_IDENTIFIER' => 'com.idea.IDEAFONT',
                                        'ENABLE_BITCODE'            => 'NO',
                                        'SWIFT_VERSION'             => '5.0',
  ...
  spec.osx.pod_target_xcconfig      = { 'PRODUCT_BUNDLE_IDENTIFIER' => 'com.idea.IDEAFONT' }
  spec.watchos.pod_target_xcconfig  = { 'PRODUCT_BUNDLE_IDENTIFIER' => 'com.idea.IDEAFONT-watchOS' }
  spec.tvos.pod_target_xcconfig     = { 'PRODUCT_BUNDLE_IDENTIFIER' => 'com.idea.IDEAFONT' }
...
#                                "${PODS_TARGET_SRCROOT}/../"
  ...
  spec.pod_target_xcconfig  = {
    'GCC_PREPROCESSOR_DEFINITIONS'  => ' MODULE=\"IDEAFONT\" '
  }

#  spec.dynamic_frameworks   = true
#  spec.build_as_static_framework  = true
  
#  spec.subspec 'FONTs' do |sub|
#    sub.resource_bundles    = {
#                                "IDEAFONT" =>
#                                [
#                                  'FONTs/Zekton/Zekton.ttf',
##                                  'FONTs/Zekton/Zekton-Italic.ttf',
#                                  'FONTs/Zekton/Zekton-Light.ttf',
##                                  'FONTs/Zekton/Zekton-LightItalic.ttf',
#                                  'FONTs/Zekton/Zekton-Bold.ttf',
##                                  'FONTs/Zekton/Zekton-BoldItalic.ttf',
#
#                                  'FONTs/SFUI/SF-UI-Text-Light.otf',
##                                  'FONTs/SFUI/SF-UI-Text-LightItalic.otf',
#                                  'FONTs/SFUI/SF-UI-Text-Regular.otf',
##                                  'FONTs/SFUI/SF-UI-Text-RegularItalic.otf',
##                                  'FONTs/SFUI/SF-UI-Text-Bold.otf',
##                                  'FONTs/SFUI/SF-UI-Text-BoldItalic.otf',
#                                  'FONTs/SFUI/SF-UI-Text-Semibold.otf',
##                                  'FONTs/SFUI/SF-UI-Text-SemiboldItalic.otf',
##                                  'FONTs/SFUI/SF-UI-Text-Medium.otf',
##                                  'FONTs/SFUI/SF-UI-Text-MediumItalic.otf',
#
#                                  'FONTs/HY/*.ttf',
#
#                                  'FONTs/MSYH/msyh.ttc',     # Regular
##                                  'FONTs/MSYH/msyhbd.ttc',   # Bold
##                                  'FONTs/MSYH/msyhhv.ttc',   # Heavy
##                                  'FONTs/MSYH/msyhl.ttc',    # Light
#                                  'FONTs/MSYH/msyhsb.ttc',   # Semibold
#                                  'FONTs/MSYH/msyhsl.ttc'    # Semilight
#                                ]
#                              }
#
...
#                                  [
#                                    'FONTs/Zekton/Zekton-Light.ttf',
#                                    'FONTs/Zekton/Zekton-Regular.ttf',
##                                    'FONTs/Zekton/Zekton-Bold.ttf',
##                                    'FONTs/Zekton/Zekton-Italic.ttf',
##                                    'FONTs/Zekton/Zekton-LightItalic.ttf',
##                                    'FONTs/Zekton/Zekton-BoldItalic.ttf',
...
##  #                                  'FONTs/SFUI/SF-UI-Text-MediumItalic.otf',
#
#                                    'FONTs/HY/HY-Light.ttf',
#                                    'FONTs/HY/HY-Regular.ttf',
##                                    'FONTs/HY/HY-Bold.ttf',
#
##if $IDEAFONT_MSYH == 'YES'
##                                    'FONTs/MSYH/msyh.ttc',     # Regular
##  #                                  'FONTs/MSYH/msyhbd.ttc',   # Bold
##  #                                  'FONTs/MSYH/msyhhv.ttc',   # Heavy
##  #                                  'FONTs/MSYH/msyhl.ttc',    # Light
...
#                                }
    ...
    spec.public_header_files  = 'IDEAFONT/IDEAFONT.h'
    spec.source_files         = 'IDEAFONT/IDEAFONT.h',
                                'IDEAFONT/IDEASystemFont.h'
#    spec.static_framework     = true

    spec.subspec 'Core' do |sub|
      sub.source_files        = 'IDEAFONT/*.{h,m}'
    end

    if ENV['IDEAFONT_HY'] == 'YES'
      spec.subspec 'HY' do |sub|
        sub.dependency 'IDEAFONT/Core'
        sub.public_header_files = 'IDEAFONT/HY/*.h'
        sub.source_files        = 'IDEAFONT/HY/*.{h,m}'
        sub.resource_bundle     = {
          'IDEAFONTHY'  => [
          'FONTs/HY/HY-Light.ttf',
          'FONTs/HY/HY-Regular.ttf',
    ...
    end # ENV['IDEAFONT_HY'] == 'YES'

    if ENV['IDEAFONT_MSYH'] == 'YES'
      spec.subspec 'MSYH' do |sub|
        sub.dependency 'IDEAFONT/Core'
        sub.public_header_files = 'IDEAFONT/MSYH/*.h'
        sub.source_files        = 'IDEAFONT/MSYH/*.{h,m}'
        sub.resource_bundle = {
          'IDEAFONTMSYH'  => [
          'FONTs/MSYH/msyh.ttc',
          'FONTs/MSYH/msyhsb.ttc',
          'FONTs/MSYH/msyhsl.ttc'
          ]
        }
      end
    end # $IDEAFONT_MSYH == 'YES'

#    spec.subspec 'SFUI' do |sub|
#      sub.dependency 'IDEAFONT/Core'
#      sub.public_header_files = 'IDEAFONT/SFUI/*.h'
#      sub.source_files        = 'IDEAFONT/SFUI/*.{h,m}'
##      sub.resource_bundle     = { 'IDEAFONTSFUI'    => [ 'FONTs/SFUI/SF-UI-Text-Light.otf', 'FONTs/SFUI/SF-UI-Text-Regular.otf', 'FONTs/SFUI/SF-UI-Text-Semibold.otf' ] }
#      spec.resource_bundles   = { 'IDEAFONT'      => [ 'FONTs/SFUI/SF-UI-Text-Light.otf', 'FONTs/SFUI/SF-UI-Text-Regular.otf', 'FONTs/SFUI/SF-UI-Text-Semibold.otf' ] }
#    end

    if ENV['IDEAFONT_ZEKTON'] == 'YES'
      spec.subspec 'Zekton' do |sub|
        sub.dependency 'IDEAFONT/Core'
        sub.public_header_files = 'IDEAFONT/Zekton/*.h'
        sub.source_files        = 'IDEAFONT/Zekton/*.{h,m}'
        #      sub.resource_bundle     = { 'IDEAFONTZEKTON'  => [ 'FONTs/Zekton/Zekton-Light.ttf', 'FONTs/Zekton/Zekton.ttf', 'FONTs/Zekton/Zekton-Bold.ttf' ] }
        sub.resource_bundle     = {
          'IDEAFONTZEKTON'  => [
          'FONTs/Zekton/Zekton-Light.ttf',
          'FONTs/Zekton/Zekton-Regular.ttf',
