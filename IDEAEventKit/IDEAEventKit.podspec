Pod::Spec.new do |spec|
  spec.name                 = "IDEAEventKit"
  spec.version              = "1.0.0"
  spec.summary              = "IDEAEventKit"
  spec.description          = "IDEAEventKit"
  spec.homepage             = "https://github.com/miniwing"
  
  spec.license              = "MIT"
#  spec.license              = { :type => 'MIT', :file => 'MIT-LICENSE.txt' }

#  spec.authors              = "Harry", "Harry"
#  spec.authors              = { "Harry" => "miniwing.hz@gmail.com",
#                                "Harry" => "miniwing.hz@gmail.com" }
...
#  spec.tvos.deployment_target     = '10.0'
  ...
  spec.ios.pod_target_xcconfig     = {
                                        'PRODUCT_BUNDLE_IDENTIFIER' => 'com.idea.IDEAEventKit',
                                        'ENABLE_BITCODE'            => 'NO',
                                        'SWIFT_VERSION'             => '5.0',
  ...
  spec.osx.pod_target_xcconfig      = { 'PRODUCT_BUNDLE_IDENTIFIER' => 'com.idea.IDEAEventKit' }
  spec.watchos.pod_target_xcconfig  = { 'PRODUCT_BUNDLE_IDENTIFIER' => 'com.idea.IDEAEventKit-watchOS' }
  spec.tvos.pod_target_xcconfig     = { 'PRODUCT_BUNDLE_IDENTIFIER' => 'com.idea.IDEAEventKit' }
  ...
  spec.xcconfig                     = {
    'HEADER_SEARCH_PATHS'               => [
                                            "${PODS_TARGET_SRCROOT}/",
                                            "${PODS_TARGET_SRCROOT}/../",
                                            "${PODS_TARGET_SRCROOT}/IDEAEventKit+Inner/",
                                            ],
...
#                                              "${PODS_CONFIGURATION_BUILD_DIR}/YYKit",
  ...
  spec.pod_target_xcconfig          = {
    'GCC_PREPROCESSOR_DEFINITIONS'      => [ ' MODULE=\"IDEAEventKit\" ' ]
                                      }
...
#  spec.watchos.source_files       = 'Classes/watchos/**/*.{h,m}'
  ...
  spec.public_header_files        = 'IDEAEventKit.h',
                                    'IDEAEventKit/**/*.{h}'

  spec.private_header_files       = 'IDEAEventKit+Inner/**/*.{h,hpp,hxx}',
                                    'IDEAEventKitExtension/**/*.{h,hpp,hxx}',
                                    'IDEAUIKitExtension/**/*.{h,hpp,hxx}'
                                    
  spec.source_files               = 'IDEAEventKit.h',
                                    'IDEAEventKit/**/*.{h,m,mm,c,cpp}',
                                    'IDEAEventKit+Inner/**/*.{h,m,mm,c,cpp}',
                                    'IDEAEventKitExtension/**/*.{h,m,mm,c,cpp}',
                                    'IDEAUIKitExtension/**/*.{h,m,mm,c,cpp}'

#  spec.preserve_path              = 'IDEAEventKitExtension/READMEE',
...
#    :script => <<-DESC
#
#    target_dir  = ${SRCROOT}/Headers/Public/${spec.name}/
#
#    mkdir -p ${target_dir}
#
#    swift_header_path = ${DERIVED_SOURCES_DIR}/${spec.name}-Swift.h
#
#    # 文件存在则copy
#    if [ -f "$swift_header_path" ];then
#        cp ${swift_header_path} ${target_dir}
#    fi
#
#    DESC
#  }
...
#import "IDEAEventKit/IDEAEventKit.h"
