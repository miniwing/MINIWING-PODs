...
#import "IDEAPaletteExpansions.h"
...
static int NameToIndex(NSString *_Nonnull name) {
   ...
   dispatch_once(&onceToken, ^{
      map = @{
         IDEA_PALETTE_TINT_50_INTERNAL_NAME : @(kQTMColorTint50Index),
         IDEA_PALETTE_TINT_100_INTERNAL_NAME : @(kQTMColorTint100Index),
         IDEA_PALETTE_TINT_200_INTERNAL_NAME : @(kQTMColorTint200Index),
         IDEA_PALETTE_TINT_300_INTERNAL_NAME : @(kQTMColorTint300Index),
         IDEA_PALETTE_TINT_400_INTERNAL_NAME : @(kQTMColorTint400Index),
         IDEA_PALETTE_TINT_500_INTERNAL_NAME : @(kQTMColorTint500Index),
         IDEA_PALETTE_TINT_600_INTERNAL_NAME : @(kQTMColorTint600Index),
         IDEA_PALETTE_TINT_700_INTERNAL_NAME : @(kQTMColorTint700Index),
         IDEA_PALETTE_TINT_800_INTERNAL_NAME : @(kQTMColorTint800Index),
         IDEA_PALETTE_TINT_900_INTERNAL_NAME : @(kQTMColorTint900Index),
         IDEA_PALETTE_ACCENT_100_INTERNAL_NAME : @(kQTMColorAccent100Index),
         IDEA_PALETTE_ACCENT_200_INTERNAL_NAME : @(kQTMColorAccent200Index),
         IDEA_PALETTE_ACCENT_400_INTERNAL_NAME : @(kQTMColorAccent400Index),
         IDEA_PALETTE_ACCENT_700_INTERNAL_NAME : @(kQTMColorAccent700Index)
      };
   });
...
UIColor *IDEAPaletteTintFromTargetColor(UIColor *targetColor, NSString *tintName) {
   NSCAssert(IDEAPaletteIsTintOrAccentName(tintName), @"Invalid tint/accent name %@.", tintName);
...
UIColor *IDEAPaletteAccentFromTargetColor(UIColor *targetColor, NSString *accentName) {
   NSCAssert(IDEAPaletteIsTintOrAccentName(accentName), @"Invalid tint/accent name %@.", accentName);
