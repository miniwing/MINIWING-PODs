Pod::Spec.new do |spec|
  spec.name                 = "IDEALitter"
  spec.version              = "1.0.0"
  spec.summary              = "IDEALitter"
  spec.description          = "IDEALitter"
...
#                                              "${PODS_CONFIGURATION_BUILD_DIR}/YYKit",
  ...
  spec.pod_target_xcconfig          = {
    'GCC_PREPROCESSOR_DEFINITIONS'      => [ ' MODULE=\"IDEALitter\" ' ]
                                      }
...
#  spec.dependency 'YYCategories'
  ...
  spec.public_header_files        = 'IDEALitter.h',
                                    'IDEALitter/**/*.{h}',
...
#    sub.ios.source_files        = 'IDEALitter/IDEALitter/**/*.{h,m,mm}'
#    sub.ios.public_header_files = 'IDEALitter/IDEALitter/**/*.{h}'
#    sub.ios.header_dir          = 'IDEALitter'
...
#import "IDEALitter/IDEALitter.h"
