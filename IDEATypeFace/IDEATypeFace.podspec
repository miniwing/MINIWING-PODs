Pod::Spec.new do |spec|
  spec.name                 = "IDEATypeFace"
  spec.version              = "1.0.0"
  spec.summary              = "IDEATypeFace"
  spec.description          = "IDEATypeFace"
...
#  spec.platform             = :ios, "12.0"
  ...
  spec.ios.pod_target_xcconfig      = {
                                        'PRODUCT_BUNDLE_IDENTIFIER' => 'com.idea.IDEATypeFace',
  ...
  spec.osx.pod_target_xcconfig      = { 'PRODUCT_BUNDLE_IDENTIFIER' => 'com.idea.IDEATypeFace' }
  spec.watchos.pod_target_xcconfig  = { 'PRODUCT_BUNDLE_IDENTIFIER' => 'com.idea.IDEATypeFace-watchOS' }
  spec.tvos.pod_target_xcconfig     = { 'PRODUCT_BUNDLE_IDENTIFIER' => 'com.idea.IDEATypeFace' }
