...
#  spec.source                       = { :git => 'https://github.com/miniwing/IDEANightVersion.git', :tag => spec.version.to_s }
  ...
  spec.osx.pod_target_xcconfig      = { 'PRODUCT_BUNDLE_IDENTIFIER' => 'com.idea.IDEAThrottle' }
  spec.watchos.pod_target_xcconfig  = { 'PRODUCT_BUNDLE_IDENTIFIER' => 'com.idea.IDEAThrottle-watchOS' }
...
#import "IDEAThrottle/IDEAThrottle.h"
