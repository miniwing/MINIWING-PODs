Pod::Spec.new do |spec|
  spec.name                 = "IDEANetUtils"
  spec.version              = "4.2.0"
  spec.summary              = "IDEANetUtils"
  spec.description          = "IDEANetUtils"
  spec.homepage             = "https://github.com/svdo/swift-netutils.git"
...
#  spec.non_arc_files  = ['Classes/Frameworks/PGSQLKit/*.{h,m}']
  ...
  spec.source                     = { :path => "." }
#  spec.source                     = { :git  => 'https://github.com/svdo/swift-netutils.git', :tag => spec.version.to_s }
...
#  spec.tvos.deployment_target     = '10.0'
  ...
  spec.ios.pod_target_xcconfig     = {
                                        'PRODUCT_BUNDLE_IDENTIFIER' => 'com.idea.IDEANetUtils',
                                        'ENABLE_BITCODE'            => 'NO',
                                        'SWIFT_VERSION'             => '5.0',
  ...
  spec.osx.pod_target_xcconfig      = { 'PRODUCT_BUNDLE_IDENTIFIER' => 'com.idea.IDEANetUtils' }
  spec.watchos.pod_target_xcconfig  = { 'PRODUCT_BUNDLE_IDENTIFIER' => 'com.idea.IDEANetUtils-watchOS' }
  spec.tvos.pod_target_xcconfig     = { 'PRODUCT_BUNDLE_IDENTIFIER' => 'com.idea.IDEANetUtils' }
...
#                                            "${PODS_ROOT}/Headers/Public/IDEANetUtils/",
...
#                                              "${PODS_CONFIGURATION_BUILD_DIR}/YYKit",
  ...
  spec.pod_target_xcconfig          = {
    'GCC_PREPROCESSOR_DEFINITIONS'      => [ ' MODULE=\"IDEANetUtils\" ' ]
                                      }
...
#  spec.dependency 'AFNetworking/NSURLSession'
  ...
  spec.public_header_files        = 'IDEANetUtils.h',
                                    'IDEANetUtils/**/*.{h}'

  spec.private_header_files       = 'IDEAFoundationExtension/**/*.{h}',
                                    'IDEAUIKitExtension/**/*.{h}'

  spec.source_files               = 'IDEANetUtils.h',
                                    'IDEANetUtils/**/*.{h,m,mm,c,cpp}',
...
#    sub.ios.source_files        = 'IDEANetUtils/IDEANetUtils/**/*.{h,m,mm}'
#    sub.ios.public_header_files = 'IDEANetUtils/IDEANetUtils/**/*.{h}'
#    sub.ios.header_dir          = 'IDEANetUtils'
...
#ifndef __DUMMY_CLASS
# define __DUMMY_CLASS(_name_)                     \\
                                                   @interface __DUMMY_CLASS_ ## _name_ : NSObject    \\
                                                   @end                                              \\
                                                   @implementation __DUMMY_CLASS_ ## _name_          \\
                                                   @end
#endif
